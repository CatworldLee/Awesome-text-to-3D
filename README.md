...
* [Zero-shot text-guided object generation with dream fields~\cite{jain2022zero}](https://openaccess.thecvf.com/content/CVPR2022/papers/Jain_Zero-Shot_Text-Guided_Object_Generation_With_Dream_Fields_CVPR_2022_paper.pdf)
* [DREAMFUSION: TEXT-TO-3D USING 2D DIFFUSION~\cite{poole2022dreamfusion}](https://arxiv.org/pdf/2209.14988.pdf)
* [Magic3D: High-Resolution Text-to-3D Content Creation~\cite{lin2022magic3d}](https://arxiv.org/pdf/2211.10440.pdf)
* [TextDeformer: Geometry Manipulation using Text Guidance~\cite{gao2023textdeformer}](https://arxiv.org/pdf/2304.13348)
* [TextMesh: Generation of Realistic 3D Meshes From Text Prompts~\cite{tsalicoglou2023textmesh}](https://arxiv.org/pdf/2304.12439)
* [DITTO-NeRF: Diffusion-based Iterative Text To Omni-directional 3D Model~\cite{seo2023ditto}](https://arxiv.org/pdf/2304.02827.pdf)
* [DreamAvatar: Text-and-Shape Guided 3D Human Avatar Generation via Diffusion Models~\cite{cao2023dreamavatar}](https://arxiv.org/pdf/2304.00916.pdf)
* [DreamFace: Progressive Generation of Animatable 3D Faces under Text Guidance~\cite{zhang2023dreamface}](https://arxiv.org/pdf/2304.03117)
* [AvatarCraft: Transforming Text into Neural Human Avatars with Parameterized Shape and Pose Control~\cite{jiang2023avatarcraft}](https://arxiv.org/pdf/2303.17606)
* [X-Mesh: Towards Fast and Accurate Text-driven 3D Stylization via Dynamic Textual Guidance~\cite{ma2023x}](https://arxiv.org/pdf/2303.15764)
* [Instruct 3D-to-3D: Text Instruction Guided 3D-to-3D conversion~\cite{kamata2023instruct}](https://arxiv.org/pdf/2304.00916.pdf)
* [Texture: Text-guided texturing of 3d shapes~\cite{richardson2023texture}](https://arxiv.org/pdf/2302.01721)
* [Fantasia3D: Disentangling Geometry and Appearance for High-quality Text-to-3D Content Creation~\cite{chen2023fantasia3d}](https://arxiv.org/pdf/2303.13873)
